  ...
  return (
    <li>
      <ListItem
        ...
        className={`${classes.listStyle} ${className}`}
      >
        {icon ? (
...
const MainListItems = (props) => {
  ...
  const [openCRMSubMenu, setCRMSubMenu] = useState(false);
  ...
  return (
    <div onClick={drawerClose} style={{ overflow: "hidden" }}>
      ...
      <ListItem
        button
        onClick={() => setCRMSubMenu(!openCRMSubMenu)}
      ...
      >
        <List component="div" disablePadding>
          ...
          >
            ...
            <ListItemText
              primary={i18n.t("mainDrawer.listItems.tagsTickets")}
              className={classes.listItemText}
            />
          </ListItem>
        </List>
