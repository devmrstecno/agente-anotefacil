		...
		translations: {
			...
			dashboard: {
				charts: {
					...
					avgTime: {
					  title: "Tiempo promedio dedicado al servicio",
					},
					tagUsage: {
					  title: "Porcentaje de uso de cada Tag",
					},
					queueUsage: {
					  title: "Porcentaje de uso de cada Cola",
					},
				  },
			},
			connections: {
    ...
    translations: {
      ...
      dashboard: {
        charts: {
          ...
          avgTime: {
            title: "Tiempo de servicio para cada asistente",
          },
          tagUsage: {
            title: "Porcentaje de uso de cada Tag",
          },
