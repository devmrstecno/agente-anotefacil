    ...
    translations: {
      ...
      dashboard: {
        charts: {
          ...
          avgTime: {
            title: "Tempo de atendimento de cada atendente",
          },
          tagUsage: {
            title: "Porcentagem de uso de cada Etiqueta",
          },
          queueUsage: {
            title: "Porcentagem de uso de cada Departamento",
          },
        },
      },
      connections: {
      ...
      whatsappModal: {
        ...
        form: {
          ...
          queueRedirectionDesc:
            "Selecione um Departamento para os contatos que não possuem Departamento serem redirecionados",
          prompt: "Prompt",
      ...
      tagModal: {
        ...
        success: "Etiqueta salvo com sucesso.",
      },
      chat: {
      ...
      mainDrawer: {
        listItems: {
          ...
          tagsTickets: "Etiquetas atendimento"
        },
        appBar: {
          user: {
            profile: "Perfil",
      ...
      campaigns: {
        ...
        dialog: {
          ...
          form: {
            ...
            queueList: "Lista de Departamentos",
      ...
      backendErrors: {
        ...
        ERR_NO_USER_DELETE:
          "Não é possível excluir o usuário Super Administrador",
        ERR_CANNOT_EDIT_SUPER_USER:
          "Não é possível alterar o perfil do usuário Super Administrador",
        ERR_CANNOT_DELETE_SUPER_COMPANY:
          "Não é possível excluir a Empresa 1, Super Administrador",
        ERR_CANNOT_UPDATE_SUPER_COMPANY_DUE_DATE:
          "Não é possível alterar a data de validade da Empresa Super Administrador",
        ERR_CANNOT_CHANGE_SUPER_ADMIN_PROFILE_TO_USER:
          "Não é permitido alterar o perfil do super administrador para user",
        ERR_CANNOT_EDIT_SUPER_USER_PROFILE:
          "Você não tem permissão para editar o perfil do super administrador",
        ERR_CANNOT_EDIT_USER_CANNOT_EDIT_ADMIN:
          "Você não tem permissão para editar ou excluir um usuario Administrador!",
        ERR_CANNOT_EDIT_OR_DELETE_OWN_ADMIN_ACCOUNT:
          "Você não tem permissão para excluir seu próprio usuário",
        ERR_CANNOT_EDIT_OR_DEMOTE_OWN_ACCOUNT:
          "Você não tem permissão para rebaixar o perfil do seu próprio usuário",
      },
    },
  },
};
